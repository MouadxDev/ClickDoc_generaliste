            ...
            <div >
                ...
                <el-dialog v-model="addPayment" title="Ajouter nouveau paiement">
                    <el-form v-model="paiement">
                        <el-form-item label="Statut / Patient ">
                            <el-select class="w-full" filterable v-model="paiement.patient_id">
								<el-option label="Autre prestation" value="0" />
						...
						<el-form-item label="Motif" v-if="paiement.patient_id==0" >
                            <el-input v-model="paiement.motif"  />
                        </el-form-item>
